...
SCENES = {
    ...
    "world_5": {
        "desc": (
            "The Void Sea — an ancient xianxia realm consumed and corrupted by the primordial Void. "
            "Flat cracked dark stone ground in the bottom quarter, its surface veined with pulsing "
            "deep violet and magenta void energy cracks (flat and clear, nothing jutting up). "
            "Midground: shattered remains of ancient Chinese ceremonial archways and stone pillars "
            "half-dissolved into void matter, their surfaces crawling with sickly purple-magenta "
            "void tendrils and corrupted glowing runes; chunks of ancient stone architecture float "
            "weightlessly, eroded at the edges into trails of violet void particles; "
            "a cracked yin-yang disc suspended in air, one half consumed by the void. "
            "Background: vast churning void sea of deep purple and magenta darkness, "
            "massive vertical void rift tears splitting the sky — glowing vivid magenta and electric violet "
            "at their edges, deep darkness within; writhing void tentacle silhouettes emerge from rifts; "
            "distant corrupted stars pulse with sickly violet light. "
            "Atmosphere: corrupted, alien, devouring — the void swallowing ancient civilisation. "
            "Palette: deep purple, vivid magenta, electric violet, void black, corrupted-stone grey, "
            "sickly neon violet glow. "
            f"{S}"
        ),
    },
    ...
    "world_6": {
        "desc": (
            "The Open Heaven — the floor of heaven itself, xianxia celestial apex. "
            "GROUND ZONE (bottom 25%, rows 192-255): a breathtaking divine floor — "
            "wide flat heavenly jade-gold paving stones, each tile etched with glowing golden "
            "bagua trigrams and celestial dao-inscription patterns that softly pulse with divine light; "
            "thin golden qi energy lines run between tiles like veins of pure heaven energy; "
            "the surface has a faint mirror-like reflectiveness catching the golden sky glow above. "
            "ABSOLUTELY NO pillars, clouds, characters or tall objects in this zone — "
            "flat and clear, just the ornate glowing floor. "
            "Midground (rows 64-192): thick rolling sea of luminous white-gold clouds; "
            "two or three enormous smooth cylindrical stone heavenly columns erupt from the cloud sea, "
            "rising massively with golden dao seal-script glowing vertically on their surfaces, "
            "their tops beyond frame; divine golden light shafts pour between them; "
            "a pair of immortal cranes soar between the columns. "
            "Background (rows 0-64): vast pale gold and white celestial sky, "
            "more cylindrical pillar silhouettes receding into radiant divine haze, "
            "a blinding divine sun-halo at the apex. "
            "Atmosphere: standing on the literal floor of heaven — divine, glorious, overwhelming. "
            "Palette: glowing gold, divine white, pale celestial blue, luminous cloud-white, "
            "ancient stone columns, sacred gold rune-light on the ground. "
            f"{S}"
        ),
    },
}

...
ENEMIES = {
    ...
    "sparring_dummy": {
        "gen_desc": (
            "Wooden sparring dummy, traditional Chinese muren zhuang training post, dark aged "
            "hardwood with a deep warm brown grain, two horizontal wooden arm pegs extending "
            "left and right from the upper post, single thick vertical post body, no face, "
            "no legs, mounted on a low crossed wooden plank base. Upright and still. "
            f"{S}"
        ),
        "idle_desc": (
            "4-frame idle animation of a traditional wooden muren zhuang sparring dummy — "
            "dark aged hardwood post with two horizontal arm pegs, mounted on a crossed plank base. "
            "Frame 1: perfectly upright, both pegs level, subtle warm grain visible on the post. "
            "Frame 2: extremely slight lean to the right — 1 or 2 pixels — as if gently swaying. "
            "Frame 3: back to perfectly upright, settled and still. "
            "Frame 4: extremely slight lean to the left — 1 or 2 pixels — completing the sway. "
            f"Seamless loop. Very subtle motion. {S}"
        ),
        "attack_desc": (
            "4-frame attack animation of a traditional wooden muren zhuang sparring dummy — "
            "dark aged hardwood post with two horizontal arm pegs, mounted on a crossed plank base. "
            "The left arm peg swings outward in a strike. "
            "Frame 1: wind-up — left peg angled slightly upward and back, right peg level, "
            "post tilting very slightly back at the base. "
            "Frame 2: mid-swing — left peg swept forward and outward at chest height, post "
            "tilting forward slightly as the arm swings out. "
            "Frame 3: full extension — left peg fully extended in a horizontal strike, post "
            "leaning forward at its maximum, right peg tilted up as counterweight. "
            "Frame 4: rebound — left peg swinging back toward level, post rocking back upright, "
            f"motion settling. {S}"
        ),
        "hit_desc": (
            "4-frame hit reaction of a traditional wooden muren zhuang sparring dummy struck "
            "by an attack. The post shakes and shudders from the impact. "
            "Frame 1: full impact — post tilting sharply to the right, both arm pegs rattling "
            "out of level, base lifting slightly on the left side from the force. "
            "Frame 2: rebound — post swinging back past centre to the left, pegs swinging in "
            "the opposite direction, base rocking back the other way. "
            "Frame 3: dampening — post oscillating back toward centre, pegs almost level, "
            "smaller motion, vibration settling. "
            "Frame 4: returned — post upright again, both pegs level, base flat, still. "
            f"{S}"
        ),
    },
    ...
    "rogue_disciple": {
        ...
        "idle_desc": (
            ...
            "faint dark qi flickering at the knuckles. "
            "Frame 1: aggressive forward-leaning stance, fists raised unevenly, weight too "
            "far forward, a barely-controlled fury in the posture. "
            "Frame 2: shifting weight side to side — unstable, twitchy, head tilting, "
            "dark qi flickering at the fists irregularly. "
            "Frame 3: a sharp exhale, body dropping lower, fists tightening, dark qi "
            "flaring briefly at the knuckles before fading. "
            "Frame 4: back to the aggressive unbalanced forward stance, eyes hollow and "
            f"scanning, dangerous and unpredictable. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "forest_spirit": {
        ...
        "idle_desc": (
            ...
            "vine arms, lower body trailing into glowing green wisps. "
            "Frame 1: hovering upright, vine arms slightly spread, green qi wisps drifting "
            "upward from the lower body, leaves gently rustling, eyes glowing steady. "
            "Frame 2: vine arms drifting inward, the whole form contracting very slightly as "
            "if breathing in, green qi condensing and brightening. "
            "Frame 3: arms spreading outward again, form expanding, leaves fanning out, "
            "pale green qi radiating gently outward from the entire silhouette. "
            "Frame 4: settling back to the hovering upright pose, qi flowing in slow spirals "
            f"upward from below. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "tree_demon": {
        ...
        "idle_desc": (
            ...
            "eyes set in a carved bark face, twisted root-legs, dead branch crown. "
            "Frame 1: standing heavily, enormous arms hanging at its sides, bark cracks "
            "glowing steadily, dead branches swaying very slightly. "
            "Frame 2: one enormous arm lifting fractionally, bark groaning, orange inner "
            "glow pulsing brighter for a moment along the cracks. "
            "Frame 3: arm lowering back, branches settling, the glow dimming back to steady, "
            "a slow ominous stillness. "
            "Frame 4: very slight shift of root-legs — repositioning weight — bark grinding, "
            f"glow pulsing once. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "sky_beast": {
        ...
        "idle_desc": (
            ...
            "pale gold qi shimmer on feather tips. "
            "Frame 1: standing on all four legs with wings half-furled, tail swaying slowly, "
            "golden eyes scanning, pale gold qi shimmering at the wing edges. "
            "Frame 2: wings spreading fractionally wider, a subtle ruffle running through "
            "the feathers, head turning to look forward, qi shimmer brightening on the tips. "
            "Frame 3: wings folding back in, a slow blink of those golden eyes, tail arcing "
            "upward briefly, feathers settling with a soft shimmer. "
            "Frame 4: back to standing with wings half-furled, golden eyes forward, "
            f"tail level, qi shimmer steady. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "thunder_hawk": {
        ...
        "idle_desc": (
            ...
            "beak, crackling talons, lightning-marked fan tail. "
            "Frame 1: standing in threat display, wings half-spread, lightning arcing "
            "steadily between feathers, electric-blue eyes burning. "
            "Frame 2: wings spreading a fraction wider, a bright crack of lightning jumping "
            "across the primary feathers, tail fanning out, beak parting slightly. "
            "Frame 3: wings drawing back in, lightning subsiding to a low crackle, head "
            "turning, a charged stillness. "
            "Frame 4: back to the wings-half-spread stance, lightning arcing at its baseline, "
            f"electric eyes scanning. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "lightning_wyrm": {
        ...
        "idle_desc": (
            ...
            "dorsal spines, forked sparking tail. "
            "Frame 1: rearing in a tall S-curve, upper body raised, head level, lightning "
            "crackling steadily along the dorsal spines and tail tip. "
            "Frame 2: the upper body swaying slowly to the right, forked tongue extending "
            "and sparking, electricity brightening at the head. "
            "Frame 3: upper body swaying back to centre, tongue retracting, a ripple of "
            "electricity pulsing down the full length of the spine ridge. "
            "Frame 4: back to the tall S-curve, head level, electricity at baseline, "
            f"eyes scanning. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "storm_elemental": {
        ...
        "idle_desc": (
            ...
            "a spinning cloud vortex. "
            "Frame 1: hovering with the cloud form churning slowly, lightning arcing between "
            "the arm tendrils and the body, white eyes blazing steadily. "
            "Frame 2: the cloud form expanding slightly, arms spreading, more lightning "
            "arcing, the lower vortex spinning faster, white eyes brightening. "
            "Frame 3: the cloud form contracting and compressing, lightning concentrating "
            "into the core and blazing intensely for a moment. "
            "Frame 4: back to the churning hover, lightning spreading back to its arcing "
            f"baseline. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "iron_fang_wolf": {
        ...
        "idle_desc": (
            "4-frame idle animation of a massive Iron Fang Wolf — far larger than a common "
            "wolf, fur like densely packed iron filaments, dark silver-grey with charcoal "
            "spine streaks, orange flame-eyes, iron-hard fangs, thick scarred hide, "
            "sharp angular metallic qi wisps radiating from its body. "
            "Frame 1: dominant predatory stance, iron-grey fur bristling along the spine, "
            "orange qi flame burning steady in both eyes, heavy scarred body carried low, "
            "metallic qi wisps crackling outward from its frame. "
            "Frame 2: shifting weight forward, massive head lowering with deliberate intent, "
            "iron-hard fangs glinting, orange eye-flame intensifying, enormous claws scoring "
            "the earth, angular metallic qi sparks crackling along its flanks. "
            "Frame 3: settling into coiled readiness, haunches tensing and rising slightly, "
            "spine arching, tail going rigid, metallic qi aura pulsing outward in sharp "
            "angular bursts. "
            "Frame 4: back to dominant stance, iron-grey fur resettling, orange flame-eyes "
            f"scanning, metallic qi stabilising. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "sand_dragon": {
        ...
        "idle_desc": (
            ...
            "sand particles. "
            "Frame 1: rearing in an S-curve, upper body raised, head level, sand particles "
            "orbiting slowly, heat shimmer visible around the body. "
            "Frame 2: head tilting downward slightly, sand particles drawing in closer and "
            "orbiting faster, scales along the neck flaring. "
            "Frame 3: head lifting back up, sand particles expanding outward, heat shimmer "
            "pulsing, a slow exhalation of hot air visible as a wave. "
            "Frame 4: back to the rearing S-pose, particles orbiting at baseline, amber eyes "
            f"burning. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "bone_construct": {
        ...
        "idle_desc": (
            ...
            "skull head with hollow purple-glowing eyes, no lower jaw. "
            "Frame 1: standing in a heavy guard, bone fists raised, purple glow pulsing "
            "steadily in the eye sockets and binding joints. "
            "Frame 2: one bone fist rising slightly, purple qi brightening at that joint, "
            "the skull tilting a fraction toward the target. "
            "Frame 3: fist lowering, purple glow returning to baseline, a slow grinding "
            "shift of the torso — bones creaking with the motion. "
            "Frame 4: back to heavy guard, fists level, purple glow steady, utterly "
            f"patient. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "desert_wraith": {
        ...
        "idle_desc": (
            ...
            "skeletal hands, lower body dissolving into orange smoke and sand. "
            "Frame 1: hovering, wrappings drifting in a phantom wind, orange smoke wisping "
            "from the lower body, hollow eyes burning steadily. "
            "Frame 2: drifting fractionally forward, wrappings billowing back, skeletal "
            "hands rising slightly, orange eyes brightening, smoke thickening. "
            "Frame 3: drifting back, wrappings settling, smoke thinning, eyes dimming "
            "briefly — a hungry patience. "
            "Frame 4: back to hovering baseline, wrappings drifting, orange smoke steady, "
            f"eyes burning. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "elemental_boar": {
        ...
        "idle_desc": (
            ...
            "legs, crystallised earth-qi spine crest. "
            "Frame 1: standing four-square, earth qi seeping steadily from hide cracks, "
            "spine crest bristling, amber eyes scanning, an immovable presence. "
            "Frame 2: snout dipping toward the ground, the hide cracks brightening as qi "
            "flows forward, tusks angling down, one stone leg scraping. "
            "Frame 3: head lifting back, earth qi pulsing once along the full spine crest, "
            "a slow heavy breath visible in the body. "
            "Frame 4: back to four-square stance, earth qi at baseline, spine crest settled, "
            f"amber eyes forward. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "city_guardian": {
        ...
        "idle_desc": (
            ...
            "with single glowing slit, carved formation arrays on chest. "
            "Frame 1: standing in guard, stone fists at sides, blue-white inscriptions "
            "pulsing steadily, a monument of immovable will. "
            "Frame 2: one fist slowly raising to a guard position, inscriptions brightening "
            "along that arm, the stone face slit brightening. "
            "Frame 3: fist lowering back, inscriptions returning to baseline, a very slight "
            "shift of weight from one stone leg to the other — grinding. "
            "Frame 4: back to guard position, all inscriptions at baseline, the guardian "
            f"eternal and patient. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "immortal_shade": {
        ...
        "idle_desc": (
            ...
            "Frame 1: hovering upright, robes drifting, spectral hair floating upward, "
            "violet qi crackling at the hands in unstable bursts. "
            "Frame 2: robes billowing as the form expands slightly, violet qi brightening "
            "at the hands and eyes, the spectral hair rising higher. "
            "Frame 3: the form compressing, violet qi concentrating into the core, robes "
            "drawing in, a moment of terrible stillness. "
            "Frame 4: back to hovering, robes drifting, violet qi at baseline crackling, "
            f"eyes burning with ancient grief and power. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "corrupted_cultivator": {
        ...
        "idle_desc": (
            ...
            "unstable dark qi tendrils radiating from the body. "
            "Frame 1: hunched aggressive stance, dark qi tendrils writhing around the body, "
            "solid black eyes staring forward, fists clenched with smoke seeping through. "
            "Frame 2: the dark qi tendrils flaring outward, head tilting back with a tremor "
            "of pain or ecstasy, fists tightening further. "
            "Frame 3: tendrils drawing back in, body dropping lower, solid black eyes "
            "refocusing forward, a shudder running through the frame. "
            "Frame 4: back to hunched stance, dark qi at baseline, fists clenched, "
            f"staring forward. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "blood_leviathan": {
        ...
        "idle_desc": (
            ...
            "from scale edges, four fin-limbs, huge fan tail. "
            "Frame 1: rearing in a massive S-curve, head raised high, blood-red qi seeping "
            "steadily, deep red eyes burning. "
            "Frame 2: the great head swaying slowly to one side, blood-red qi brightening "
            "from the scale edges, fan tail spreading. "
            "Frame 3: head swaying back to centre, a slow exhalation — blood-red qi puffing "
            "outward in a brief cloud, tail resettling. "
            "Frame 4: back to rearing S-pose, blood-red qi at baseline, deep red eyes "
            f"scanning. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "burial_guardian": {
        ...
        "idle_desc": (
            ...
            "Frame 1: standing at guard with the halberd raised, pale green qi leaking "
            "steadily from the inscription cracks, eye slits glowing steadily. "
            "Frame 2: halberd lowering fractionally in a challenge gesture, pale green qi "
            "brightening at the chest plate cracks and eye slits. "
            "Frame 3: halberd lifting back to guard, qi returning to baseline — ancient "
            "and patient, this guardian has stood here for ages. "
            "Frame 4: the merest shift of weight, armour grinding, eye slits scanning "
            f"left. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "saint_corpse_soldier": {
        ...
        "idle_desc": (
            ...
            "flame eyes, golden cultivation gloves crackling with unstable saint qi. "
            "Frame 1: standing upright with commanding posture, pale gold death-qi flames "
            "burning in the eye sockets, saint qi crackling at the gloved hands. "
            "Frame 2: robes stirring from an internal qi pulse, the pale gold eye-flames "
            "brightening, one hand rising slightly in a cultivation gesture. "
            "Frame 3: the gesture completing, saint qi pulsing outward once from the hand, "
            "robes settling, eye-flames returning to baseline. "
            "Frame 4: back to commanding upright stance, pale gold flames steady, crackling "
            f"saint qi at the hands. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "void_rift_predator": {
        ...
        "idle_desc": (
            ...
            "void-light eye slits, space rifts opening on its back. "
            "Frame 1: standing in predator crouch, edges flickering, white eye slits burning "
            "steadily, small space rifts opening and closing along the back. "
            "Frame 2: the void-form briefly expanding, edges distorting more intensely, "
            "eye slits brightening, a new rift tearing open larger on the back. "
            "Frame 3: the form compressing and sharpening, edges stabilising slightly, "
            "rifts sealing to thin lines, a moment of focused stillness. "
            "Frame 4: back to flickering predator crouch, baseline distortion, white eye "
            f"slits burning, rifts cycling. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "origin_guardian": {
        ...
        "idle_desc": (
            ...
            "Frame 1: standing in absolute stillness, origin qi formations rotating slowly "
            "around the body, white eye-ring blazing, the air warping around the presence. "
            "Frame 2: the qi formations accelerating their rotation briefly, origin energy "
            "condensing, crystals brightening, a pulse of overwhelming force. "
            "Frame 3: formations slowing back to baseline, a slow exhalation of origin qi "
            "expanding outward in a ring. "
            "Frame 4: back to still standing, formations rotating, eye-ring steady, "
            f"timeless and patient. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "ancient_beast": {
        ...
        "idle_desc": (
            ...
            "golden origin eyes, crystal claws, ground cracking under its weight. "
            "Frame 1: standing four-square, origin-qi crystal scales glowing steadily, "
            "golden eyes burning, ground cracked and glowing beneath each foot. "
            "Frame 2: the great head lowering, origin-qi brightening in the eye scales, "
            "the glow intensifying across the dorsal scales. "
            "Frame 3: head lifting, a slow powerful exhale of golden origin qi drifting "
            "from the nostrils in dense clouds. "
            "Frame 4: back to four-square, crystal scales at baseline glow, golden eyes "
            f"forward, a mountain that breathes. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "void_elemental": {
        ...
        "idle_desc": (
            ...
            "void-tendril arms, lower body a void vortex, space rifts. "
            "Frame 1: hovering, void form churning slowly, purple eyes blazing, space "
            "rifts cycling open and closed across the surface. "
            "Frame 2: the void form expanding, darkness deepening, purple eyes brightening, "
            "rifts opening wider. "
            "Frame 3: form contracting, darkness compressing, purple eyes dimming to cold "
            "embers briefly, a terrible stillness. "
            "Frame 4: back to hovering, void churning, purple eyes blazing, rifts cycling. "
            f"Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "dao_inscription_guardian": {
        ...
        "idle_desc": (
            ...
            "Frame 1: standing, inscription patterns pulsing with a slow steady rhythm, "
            "orbiting rune fragments drifting in slow orbits, dao light eyes blazing. "
            "Frame 2: inscription patterns brightening across the entire body, orbiting "
            "runes accelerating, new inscription characters briefly appearing and fading. "
            "Frame 3: patterns dimming to baseline, orbiting runes slowing, a slow "
            "pulse outward — the guardian perpetually writing the Dao. "
            "Frame 4: back to steady stance, inscriptions pulsing, dao eyes blazing, "
            f"runes orbiting. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "open_heaven_beast": {
        ...
        "idle_desc": (
            ...
            "Frame 1: standing with wings half-spread, celestial scales blazing steadily, "
            "gold eyes burning with heaven-fire, orbiting celestial clouds drifting. "
            "Frame 2: wings spreading wider, celestial light blazing intensely, the five "
            "horns radiating gold celestial qi, orbiting clouds accelerating. "
            "Frame 3: wings folding back, celestial light dimming slightly, a slow breath "
            "of heaven-fire exhaling from the nostrils. "
            "Frame 4: back to wings-half-spread, celestial scales blazing, gold eyes "
            f"scanning, orbiting clouds steady. Seamless loop. {S}"
        ),
        "attack_desc": (
    ...
    "boundary_wraith": {
        ...
        "idle_desc": (
            ...
            "Frame 1: hovering, form flickering between solid and translucent, boundary "
            "energy pulsing, void-black and gold fires burning in the eye sockets. "
            "Frame 2: the form shifting toward the void aspect — translucency increasing, "
            "void darkness spreading from the hands, void-black eye fire brightening. "
            "Frame 3: the form shifting toward the heaven aspect — becoming more solid, "
            "heaven-fire blazing from the hands, gold eye fire brightening. "
            "Frame 4: back to the in-between hover, both aspects balanced, boundary "
            f"energy pulsing. Seamless loop. {S}"
        ),
        "attack_desc": (

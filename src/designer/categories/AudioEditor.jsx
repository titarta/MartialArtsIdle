  ...
  },
  {
    ...
    items: [
      ...
      { id: 'cult_breakthrough_continue',   label: 'Major BT: Continue',   desc: 'Plays when the player taps to dismiss the cinematic' },
      {
        ...
        desc: 'Escalating loop while focus is held. Level 1 is a plain hold; each Consecutive Focus rung climbed steps to the next level. Level 6 is the distinct max-tier loop when the player reaches T5 (the top rung); make it the most satisfying payoff. One sample per level; leave higher levels empty to reuse a lower one.',
        variants: 6,
        variantLabel: 'Level',
        loops: true,
      },
      {
        id: 'focus_tick',
        label: 'Focus Tick',
        desc: 'Instant one-shot fired at each focus-level transition (paired with the loop). One per level (level 1 = on press, then one per rung climbed; level 6 = the T5 max tier).',
        variants: 6,
        variantLabel: 'Level',
      },
    ],

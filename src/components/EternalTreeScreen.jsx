...
const NODE_POS = {
  ...
  yy_1: [268, 232], yy_2: [268, 450], yy_3: [269, 672], yy_4: [269, 902], yy_k: [269, 1134],
...
const CUSTOM_CP = {
  ...
  'yy_1-yy_2': { cp: { x: -10, y: 326.5 } },
  'yy_2-yy_3': { cp: { x: -14, y: 554.5 } },
  'yy_3-yy_4': { cp: { x: -20, y: 786.5 } },
  'yy_4-yy_k': { cp: { x: -23.638399159208547, y: 1021.4998258694764 } },

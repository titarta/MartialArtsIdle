...
export const ARTEFACT_UNIQUES = [
  ...
  { id: 'a_sharp_mind',        name: 'Sharp Mind', slot: 'weapon', range: { min: 10, max: 30 }, description: '+{value}% damage with techniques matching weapon type.' },
  ...
  { id: 'a_qi_blade',          name: 'Qi Blade', slot: 'weapon', range: { min: 1, max: 4 }, description: 'Each 100 qi adds {value} flat damage.' },
  { id: 'a_void_cleaver',      name: 'Void Cleaver', slot: 'weapon', range: { min: 10, max: 25 }, description: 'Ignore {value}% of enemy defense.' },
  { id: 'a_resonant_strike',   name: 'Resonant Strike', slot: 'weapon', range: { min: 20, max: 60 }, description: '+{value}% bonus damage when law element matches.' },
  { id: 'a_perfect_balance',   name: 'Perfect Balance', slot: 'weapon', range: { min: 5, max: 15 }, description: '+{value}% damage per equipped artefact.' },
  { id: 'a_thirsty_blade',     name: 'Thirsty Blade', slot: 'weapon', range: { min: 5, max: 15 }, description: '+{value}% damage per kill in last 10s.' },
  { id: 'a_dragon_tooth',      name: 'Dragon Tooth', slot: 'weapon', range: { min: 20, max: 60 }, description: '+{value}% damage to enemies above your realm.' },
  { id: 'a_phantom_edge',      name: 'Phantom Edge', slot: 'weapon', range: { min: 10, max: 30 }, description: 'Attack cooldowns -{value}%.' },
  { id: 'a_storm_blade',       name: 'Storm Blade', slot: 'weapon', range: { min: 20, max: 60 }, description: '+{value}% lightning damage.' },
  { id: 'a_burning_brand',     name: 'Burning Brand', slot: 'weapon', range: { min: 20, max: 60 }, description: 'Attacks burn for {value}% damage over 3s.' },
  { id: 'a_frost_fang',        name: 'Frost Fang', slot: 'weapon', range: { min: 10, max: 30 }, description: 'Hits slow enemy attack speed by {value}% for 2s.' },
  ...
  { id: 'a_essence_drain',     name: 'Essence Drain', slot: 'weapon', range: { min: 1, max: 4 }, description: 'Steal {value}% essence per hit (max 30%).' },
  ...
  { id: 'a_third_eye',         name: 'Third Eye', slot: 'head', range: { min: 10, max: 30 }, description: '+{value}% damage to weakened enemies.' },
  { id: 'a_battle_meditation', name: 'Battle Meditation', slot: 'head', range: { min: 20, max: 60 }, description: '+{value}% qi gain in combat.' },
  { id: 'a_iron_will',         name: 'Iron Will', slot: 'head', range: { min: 30, max: 80 }, description: '+{value}% soul toughness.' },
  ...
  { id: 'a_void_gaze',         name: 'Void Gaze', slot: 'head', range: { min: 5, max: 15 }, description: '+{value}% damage to enemies you have stunned.' },
  ...
  { id: 'a_dragons_gaze',      name: 'Dragon\'s Gaze', slot: 'head', range: { min: 20, max: 50 }, description: '+{value}% elemental damage.' },
  ...
  { id: 'a_golden_diadem',     name: 'Golden Diadem', slot: 'head', range: { min: 5, max: 15 }, description: '+{value}% all loot.' },
  { id: 'a_helm_eternity',     name: 'Helm of Eternity', slot: 'head', range: { min: 1, max: 4 }, description: '+{value}% HP/s out of combat.' },
  ...
  { id: 'a_iron_carapace',     name: 'Iron Carapace', slot: 'body', range: { min: 10, max: 30 }, description: '+{value}% defense.' },
  ...
  { id: 'a_bramble_garb',      name: 'Bramble Garb', slot: 'body', range: { min: 5, max: 15 }, description: 'Attackers take {value}% of damage dealt as recoil.' },
  ...
  { id: 'a_bone_armor',        name: 'Bone Armor', slot: 'body', range: { min: 10, max: 30 }, description: '+{value}% physical defense.' },
  { id: 'a_dragon_scales',     name: 'Dragon Scales', slot: 'body', range: { min: 10, max: 30 }, description: '+{value}% elemental defense.' },
  ...
  { id: 'a_voidwalker_garb',   name: 'Voidwalker Garb', slot: 'body', range: { min: 1, max: 5 }, description: '+{value}% chance to phase through attacks.' },
  ...
  // ── Hands-specific ──
  { id: 'a_titan_grip',        name: 'Titan Grip', slot: 'hands', range: { min: 5, max: 15 }, description: '+{value}% physical damage.' },
  { id: 'a_swift_palms',       name: 'Swift Palms', slot: 'hands', range: { min: 5, max: 15 }, description: '+{value}% attack speed.' },
  ...
  { id: 'a_iron_fists',        name: 'Iron Fists', slot: 'hands', range: { min: 10, max: 30 }, description: '+{value}% punch damage.' },
  { id: 'a_flame_palms',       name: 'Flame Palms', slot: 'hands', range: { min: 20, max: 50 }, description: '+{value}% fire damage.' },
  { id: 'a_lightning_grip',    name: 'Lightning Grip', slot: 'hands', range: { min: 10, max: 25 }, description: 'Crits chain to nearby enemies for {value}% damage.' },
  ...
  { id: 'a_soul_grip',         name: 'Soul Grip', slot: 'hands', range: { min: 5, max: 15 }, description: '+{value}% Soul.' },
  ...
  { id: 'a_assassin_grip',     name: 'Assassin Grip', slot: 'hands', range: { min: 50, max: 150 }, description: '+{value}% crit damage from behind.' },
  { id: 'a_warriors_grip',     name: 'Warrior\'s Grip', slot: 'hands', range: { min: 5, max: 15 }, description: '+{value}% damage and defense.' },
  { id: 'a_eternal_grip',      name: 'Eternal Grip', slot: 'hands', range: { min: 5, max: 15 }, description: 'Cannot be disarmed. +{value}% qi gen.' },
  ...
  { id: 'a_grip_of_kings',     name: 'Grip of Kings', slot: 'hands', range: { min: 10, max: 25 }, description: '+{value}% experience gain.' },
  { id: 'a_phoenix_palms',     name: 'Phoenix Palms', slot: 'hands', range: { min: 5, max: 15 }, description: 'Fire damage heals {value}% of dealt damage.' },

  // ── Waist-specific ──
  { id: 'a_dantian_seal',      name: 'Dantian Seal', slot: 'waist', range: { min: 10, max: 30 }, description: '+{value}% qi cap.' },
  { id: 'a_unbreakable_belt',  name: 'Unbreakable Belt', slot: 'waist', range: { min: 10, max: 30 }, description: '+{value}% max HP.' },
  { id: 'a_qi_storage',        name: 'Qi Storage', slot: 'waist', range: { min: 10, max: 30 }, description: '+{value}% qi gain.' },
  { id: 'a_warrior_belt',      name: 'Warrior\'s Belt', slot: 'waist', range: { min: 5, max: 15 }, description: '+{value}% damage.' },
  { id: 'a_speed_belt',        name: 'Speed Belt', slot: 'waist', range: { min: 5, max: 15 }, description: '+{value}% movement and dodge.' },
  { id: 'a_sage_belt',         name: 'Sage\'s Belt', slot: 'waist', range: { min: 5, max: 15 }, description: '+{value}% pill effects.' },
  { id: 'a_dragon_belt',       name: 'Dragon Belt', slot: 'waist', range: { min: 10, max: 30 }, description: '+{value}% elemental damage.' },
  { id: 'a_essence_belt',      name: 'Essence Belt', slot: 'waist', range: { min: 5, max: 15 }, description: 'Convert {value}% body to essence.' },
  { id: 'a_soul_belt',         name: 'Soul Belt', slot: 'waist', range: { min: 5, max: 15 }, description: '+{value}% Soul.' },
  ...
  { id: 'a_void_sash',         name: 'Void Sash', slot: 'waist', range: { min: 1, max: 5 }, description: '+{value} extra inventory slots.' },
  ...
  { id: 'a_qi_belt',           name: 'Qi Belt', slot: 'waist', range: { min: 10, max: 25 }, description: '+{value}% qi/sec.' },
  { id: 'a_assassin_belt',     name: 'Assassin Belt', slot: 'waist', range: { min: 5, max: 15 }, description: '+{value}% crit chance.' },

  // ── Feet-specific ──
  { id: 'a_wind_step',         name: 'Wind Step', slot: 'feet', range: { min: 5, max: 15 }, description: '+{value}% movement.' },
  { id: 'a_swift_boots',       name: 'Swift Boots', slot: 'feet', range: { min: 5, max: 15 }, description: '+{value}% dodge chance.' },
  { id: 'a_thunder_boots',     name: 'Thunder Boots', slot: 'feet', range: { min: 10, max: 25 }, description: '+{value}% lightning damage.' },
  ...
  { id: 'a_sky_walker',        name: 'Sky Walker', slot: 'feet', range: { min: 5, max: 15 }, description: '+{value}% movement. +{value}% HP regen.' },
  { id: 'a_blood_boots',       name: 'Blood Boots', slot: 'feet', range: { min: 10, max: 30 }, description: '+{value}% damage. {value/3}% recoil.' },
  ...
  { id: 'a_void_boots',        name: 'Void Boots', slot: 'feet', range: { min: 1, max: 5 }, description: '+{value}% chance to phase through attacks.' },
  { id: 'a_combo_boots',       name: 'Combo Boots', slot: 'feet', range: { min: 5, max: 15 }, description: '+{value}% damage after each dodge.' },
  { id: 'a_qi_boots',          name: 'Qi Boots', slot: 'feet', range: { min: 5, max: 15 }, description: '+{value}% qi/s.' },
  { id: 'a_dao_boots',         name: 'Dao Boots', slot: 'feet', range: { min: 5, max: 15 }, description: '+{value}% damage per realm.' },
  { id: 'a_storm_boots',       name: 'Storm Boots', slot: 'feet', range: { min: 10, max: 30 }, description: '+{value}% lightning damage.' },
  { id: 'a_thirsty_boots',     name: 'Thirsty Boots', slot: 'feet', range: { min: 1, max: 4 }, description: 'Heal {value}% per kill.' },
  ...
  { id: 'a_phoenix_charm',     name: 'Phoenix Charm', slot: 'neck', range: { min: 30, max: 80 }, description: 'Once per fight, heal {value}% HP.' },
  { id: 'a_void_pendant',      name: 'Void Pendant', slot: 'neck', range: { min: 5, max: 15 }, description: 'Ignore {value}% enemy defense.' },
  { id: 'a_iron_amulet',       name: 'Iron Amulet', slot: 'neck', range: { min: 5, max: 15 }, description: '+{value}% defense.' },
  ...
  { id: 'a_silver_locket',     name: 'Silver Locket', slot: 'neck', range: { min: 5, max: 15 }, description: '+{value}% gold from kills.' },
  { id: 'a_warlords_amulet',   name: 'Warlord\'s Amulet', slot: 'neck', range: { min: 5, max: 15 }, description: '+{value}% damage and defense.' },
  { id: 'a_crystal_pendant',   name: 'Crystal Pendant', slot: 'neck', range: { min: 10, max: 30 }, description: '+{value}% elemental damage.' },
  ...
  { id: 'a_balance_amulet',    name: 'Amulet of Balance', slot: 'neck', range: { min: 5, max: 15 }, description: '+{value}% to all stats.' },
  ...
  { id: 'a_storm_pendant',     name: 'Storm Pendant', slot: 'neck', range: { min: 10, max: 25 }, description: '+{value}% lightning damage.' },
  { id: 'a_chained_amulet',    name: 'Chained Amulet', slot: 'neck', range: { min: 30, max: 80 }, description: '+{value}% all stats. Cannot use rings.' },
  ...
  { id: 'a_phoenix_ring',      name: 'Phoenix Ring', slot: 'ring', range: { min: 30, max: 80 }, description: 'Once per fight, heal {value}% HP.' },
  ...
  { id: 'a_qi_ring',           name: 'Qi Ring', slot: 'ring', range: { min: 5, max: 15 }, description: '+{value}% qi gain.' },

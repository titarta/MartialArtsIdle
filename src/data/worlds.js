    ...
    regions: [
      {
        ...
        drops: 'Qi Fragment, Cracked Qi Stone',
        herbs: 'Mortal Qi Grass',
        ores: 'Cracked Qi Stone',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Qi Fragment, Beast Core Shard, Cracked Qi Stone',
        herbs: 'Mortal Qi Grass, Qi Vein Vine',
        ores: 'Cracked Qi Stone, Qi Beast Fang',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Qi Fragment, Beast Core Shard, Qi Beast Fang',
      ...
      },
      {
        ...
        drops: 'Qi Fragment, Beast Core Shard, Spirit Wood Sliver',
        herbs: 'Misty Forest Bloom',
        ores: 'Qi Beast Fang, Spirit Wood Sliver',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Beast Core Shard, Qi Beast Fang, Spirit Wood Sliver',
        herbs: 'Qi Vein Vine, Misty Forest Bloom',
        ores: 'Spirit Wood Sliver',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Beast Core Shard, Qi Crystal, Spirit Wood Sliver',
        herbs: 'Misty Forest Bloom',
        ores: 'Spirit Wood Sliver',
        enemyPool: [
    ...
    regions: [
      {
        ...
        drops: 'Silver Spirit Essence, Iron Spine Fragment, Array Jade Shard',
        herbs: 'Desert Silver Lotus, Blood Reed',
        ores: 'Iron Spine Fragment, Array Jade Shard',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Beast Core Shard, Silver Spirit Essence, Iron Spine Fragment',
        herbs: 'Desert Silver Lotus',
        ores: 'Iron Spine Fragment',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Silver Spirit Essence, Soul Shard, Array Jade Shard',
        herbs: 'Desert Silver Lotus, Blood Reed',
        ores: 'Iron Spine Fragment, Array Jade Shard',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Soul Shard, Array Jade Shard, Saint Bone Sliver',
        herbs: 'Blood Reed',
        ores: 'Array Jade Shard',
        enemyPool: [
    ...
    regions: [
      {
        ...
        ores: 'Array Jade Shard, Saint Bone Sliver',
        enemyPool: [
    ...
    regions: [
      {
        ...
        drops: 'Primordial Qi Essence, Void Crystal',
      ...
      },
      {
        ...
        drops: 'Primordial Qi Essence, Heaven Core Crystal, Void Crystal',
        herbs: 'Origin Spring Petal',
        ores: 'Void Crystal',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Heaven Core Crystal, Void Crystal, Origin Stone Core',
        herbs: 'Origin Spring Petal, Heaven Root Vine',
        ores: 'Void Crystal, Origin Stone Core',
        enemyPool: [
      ...
      },
      {
        ...
        minRealmIndex: 35,
        enemies: 'Root sovereigns, deep earth titans',
        drops: 'Heaven Core Crystal, Origin Stone Core',
    ...
    regions: [
      {
        ...
        drops: 'Primordial Qi Essence, Void Crystal, Origin Stone Core',
        herbs: 'Origin Spring Petal',
        ores: 'Void Crystal, Origin Stone Core',
        enemyPool: [
      ...
      },
      {
        ...
        drops: 'Primordial Qi Essence, Heaven Core Crystal, Origin Stone Core',
        herbs: 'Origin Spring Petal',
        ores: 'Void Crystal',
        enemyPool: [

...
export const SPARK_COPY = {
  // ── Common ─────────────────────────────────────────────────────────────
  // Card copy rewritten 2026-05-25 for concision so every effectText fits
  // inside the picker's effect area at 13px without graceful-truncation
  // masking. References to retired systems (laws, alchemy, artefacts,
  // techniques) removed. exampleText / loreText kept verbose, they only
  // surface in the SparksTab detail panel which can afford the room.
  quick_burst: {
    icon: '/ui/spark_quick_burst.png',
    heroGlyph: '速',
  ...
  surging_stream: {
    icon: '/ui/spark_surging_stream.png',
    heroGlyph: '潮',
  ...
  steady_stream: {
    icon: '/ui/spark_steady_stream.png',
    heroGlyph: '流',
  ...
  sect_discipline: {
    icon: '/ui/spark_sect_discipline.png',
    heroGlyph: '律',
  ...
  // ── Uncommon ───────────────────────────────────────────────────────────
  steady_cultivation: {
    icon: '/ui/spark_steady_cultivation.png',
    heroGlyph: '修',
  ...
  sharper_focus: {
    icon: '/ui/spark_sharper_focus.png',
    heroGlyph: '锐',
  ...
  enduring_stream: {
    icon: '/ui/spark_enduring_stream.png',
    heroGlyph: '恒',
  ...
  masters_patience: {
    icon: '/ui/spark_masters_patience.png',
    heroGlyph: '耐',
  ...
  tinkers_bargain: {
    icon: '/ui/spark_tinkers_bargain.png',
    heroGlyph: '匠',
  ...
  heavens_bond: {
    icon: '/ui/spark_heavens_bond.png',
    heroGlyph: '缘',
  ...
  resonant_soul: {
    icon: '/ui/spark_resonant_soul.png',
    heroGlyph: '魂',

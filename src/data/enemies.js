...
const ENEMIES_RAW = {
  ...
  iron_fang_wolf: {
    ...
    drops: [
      { itemId: 'bronze_blood_core_1', chance: 1.0, qty: [1, 1] },
    ],
    techniqueDrop: { chance: 0.02 },
  },
  ...
  bone_construct: {
    ...
    drops: [
      { itemId: 'bronze_cultivation_1', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  immortal_shade: {
    ...
    drops: [
      { itemId: 'bronze_blood_core_2', chance: 1.0, qty: [1, 1] },
    ],
    techniqueDrop: { chance: 0.03 },
  },
  ...
  corrupted_cultivator: {
    ...
    drops: [
      { itemId: 'iron_cultivation_2',   chance: 1.0, qty: [1, 1] },
      { itemId: 'bronze_cultivation_2', chance: 1.0, qty: [1, 1] },
    ],
  ...
  burial_guardian: {
    ...
    drops: [
      { itemId: 'bronze_cultivation_1', chance: 1.0, qty: [1, 1] },
      { itemId: 'silver_cultivation_1', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  ancient_war_spirit: {
    ...
    drops: [
      { itemId: 'silver_blood_core_2', chance: 1.0, qty: [1, 1] },
    ],
    techniqueDrop: { chance: 0.03 },
  },
  ...
  saint_bone_sovereign: {
    ...
    drops: [
      { itemId: 'silver_cultivation_1', chance: 1.0, qty: [1, 1] },
      { itemId: 'silver_cultivation_2', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  void_shade: {
    ...
    drops: [
      { itemId: 'silver_blood_core_1', chance: 1.0, qty: [1, 1] },
    ],
    techniqueDrop: { chance: 0.04 },
  },
  ...
  origin_guardian: {
    ...
    drops: [
      { itemId: 'gold_cultivation_1', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  primordial_serpent: {
    ...
    drops: [
      { itemId: 'gold_blood_core_1', chance: 1.0, qty: [1, 1] },
    ],
    techniqueDrop: { chance: 0.03 },
  },
  ...
  deep_earth_titan: {
    ...
    drops: [
      { itemId: 'gold_cultivation_2', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  spatial_fissure_beast: {
    ...
    drops: [
      { itemId: 'gold_blood_core_2', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  dao_inscription_guardian: {
    ...
    drops: [
      { itemId: 'transcendent_cultivation_1', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  dao_inscription_revenant: {
    ...
    drops: [
      { itemId: 'transcendent_cultivation_1', chance: 1.0, qty: [1, 1] },
      { itemId: 'transcendent_blood_core_1',  chance: 1.0, qty: [1, 1] },
    ],
    techniqueDrop: { chance: 0.04 },
  },
  ...
  boundary_wraith: {
    ...
    drops: [
      { itemId: 'transcendent_cultivation_2', chance: 1.0, qty: [1, 1] },
    ],
  },
  ...
  open_heaven_beast: {
    ...
    drops: [
      { itemId: 'transcendent_blood_core_2', chance: 1.0, qty: [1, 1] },
    ],
  },

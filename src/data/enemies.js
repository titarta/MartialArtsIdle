...
const ENEMIES_RAW = {
  ...
  rogue_disciple: {
    ...
    drops: [
      { itemId: 'iron_cultivation_2', chance: 1.0, qty: [3, 4] },
      { itemId: 'iron_blood_core_1',  chance: 1.0, qty: [3, 4] },
    ],
  ...
  bone_construct: {
    ...
    drops: [
      { itemId: 'bronze_cultivation_1', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  corrupted_cultivator: {
    ...
    drops: [
      { itemId: 'iron_cultivation_2',   chance: 1.0, qty: [3, 4] },
      { itemId: 'bronze_cultivation_2', chance: 1.0, qty: [3, 4] },
    ],
  ...
  burial_guardian: {
    ...
    drops: [
      { itemId: 'bronze_cultivation_1', chance: 1.0, qty: [3, 4] },
      { itemId: 'silver_cultivation_1', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  ancient_war_spirit: {
    ...
    drops: [
      { itemId: 'silver_blood_core_2', chance: 1.0, qty: [3, 4] },
    ],
    techniqueDrop: { chance: 0.05 },
  },
  ...
  saint_bone_sovereign: {
    ...
    drops: [
      { itemId: 'silver_cultivation_1', chance: 1.0, qty: [3, 4] },
      { itemId: 'silver_cultivation_2', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  void_shade: {
    ...
    drops: [
      { itemId: 'silver_blood_core_1', chance: 1.0, qty: [3, 4] },
    ],
    techniqueDrop: { chance: 0.06 },
  },
  ...
  origin_guardian: {
    ...
    drops: [
      { itemId: 'gold_cultivation_1', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  primordial_serpent: {
    ...
    drops: [
      { itemId: 'gold_blood_core_1', chance: 1.0, qty: [3, 4] },
    ],
    techniqueDrop: { chance: 0.05 },
  },
  ...
  deep_earth_titan: {
    ...
    drops: [
      { itemId: 'gold_cultivation_2', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  spatial_fissure_beast: {
    ...
    drops: [
      { itemId: 'gold_blood_core_2', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  dao_inscription_guardian: {
    ...
    drops: [
      { itemId: 'transcendent_cultivation_1', chance: 1.0, qty: [3, 4] },
    ],
  },
  ...
  dao_inscription_revenant: {
    ...
    drops: [
      { itemId: 'transcendent_cultivation_1', chance: 1.0, qty: [3, 4] },
      { itemId: 'transcendent_blood_core_1',  chance: 1.0, qty: [3, 4] },
    ],
    techniqueDrop: { chance: 0.06 },
  },

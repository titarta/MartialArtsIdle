...
export const TECHNIQUES = [
  ...
  { id: 'stone_skin', name: 'Stone Skin', type: 'Defend', rank: 'Mortal', quality: 'Iron', element: 'Normal', flavour: 'Flesh becomes iron. Iron becomes stone.', defMult: 1.5, buffDuration: 5, passives: [{ name: 'Hardened', description: 'DEF bonus lasts 2 extra seconds.' }] },
  { id: 'iron_fortress', name: 'Iron Fortress', type: 'Defend', rank: 'Earth', quality: 'Silver', element: 'Normal', flavour: "A citadel of qi — no blow can shake its walls.", defMult: 2.0, buffDuration: 7, passives: [{ name: 'Unbreakable', description: 'Cannot be reduced below 1 HP while active.' }, { name: 'Counterforce', description: '20% of blocked damage returned.' }, { name: 'Ironclad', description: 'Duration +1s per hit absorbed.' }] },
  { id: 'phantom_step', name: 'Phantom Step', type: 'Dodge', rank: 'Mortal', quality: 'Iron', element: 'Normal', flavour: 'Between one heartbeat and the next — you are elsewhere.', dodgeChance: 0.40, buffDuration: 4, passives: [{ name: 'Swift', description: 'Dodge window extended by 0.5s.' }] },
  { id: 'shadow_walk', name: 'Shadow Walk', type: 'Dodge', rank: 'Earth', quality: 'Bronze', element: 'Normal', flavour: 'The shadow peels away and becomes you for a precious moment.', dodgeChance: 0.60, buffDuration: 6, passives: [{ name: 'Afterimage', description: 'Afterimage taunts enemy for 1s.' }, { name: 'Phase Shift', description: 'First attack after dodge deals ×1.5 dmg.' }] },
];

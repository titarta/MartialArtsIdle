 ...
 * NEW items: include `_category: 'herbs' | 'minerals' | 'bloodCores' | 'pills' | 'cultivation'`
...
// Alias for components that imported ITEM_RARITY from pills.js (now unified here)
...
const ITEMS = {
  ...
  bloodCores: [
    { id: 'iron_blood_core_1',         name: 'Iron Blood Core 1',         rarity: 'Iron',         description: 'Placeholder — a dense iron-grade blood core extracted from a fallen enemy.' },
    { id: 'iron_blood_core_2',         name: 'Iron Blood Core 2',         rarity: 'Iron',         description: 'Placeholder — a crystallised iron-grade blood essence condensed from mortal cultivators.' },
    { id: 'bronze_blood_core_1',       name: 'Bronze Blood Core 1',       rarity: 'Bronze',       description: 'Placeholder — a bronze-grade blood core pulsing with beast vitality.' },
    { id: 'bronze_blood_core_2',       name: 'Bronze Blood Core 2',       rarity: 'Bronze',       description: 'Placeholder — a shard of condensed bronze-grade blood qi from corrupted entities.' },
    { id: 'silver_blood_core_1',       name: 'Silver Blood Core 1',       rarity: 'Silver',       description: 'Placeholder — a silver-grade blood core saturated with ancient frontier vitality.' },
    { id: 'silver_blood_core_2',       name: 'Silver Blood Core 2',       rarity: 'Silver',       description: 'Placeholder — a remnant blood crystal from an immortal-realm entity.' },
    { id: 'gold_blood_core_1',         name: 'Gold Blood Core 1',         rarity: 'Gold',         description: 'Placeholder — a saint-grade blood core radiating cold death qi.' },
    { id: 'gold_blood_core_2',         name: 'Gold Blood Core 2',         rarity: 'Gold',         description: 'Placeholder — a void-attribute blood pearl from a gold-grade predator.' },
    { id: 'transcendent_blood_core_1', name: 'Transcendent Blood Core 1', rarity: 'Transcendent', description: 'Placeholder — a primordial blood core condensed from an entity beyond mortal limitations.' },
    { id: 'transcendent_blood_core_2', name: 'Transcendent Blood Core 2', rarity: 'Transcendent', description: 'Placeholder — a heaven-grade blood crystal radiating overwhelming pressure.' },
  ],
  pills: [
    { id: 'qi_condensation_pill',  name: 'Qi Condensation Pill',  rarity: 'Iron',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'body_tempering_pill',   name: 'Body Tempering Pill',   rarity: 'Iron',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'spirit_calming_pill',   name: 'Spirit Calming Pill',   rarity: 'Iron',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'fortification_pill',    name: 'Fortification Pill',    rarity: 'Iron',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'miners_focus_pill',     name: "Miner's Focus Pill",    rarity: 'Iron',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'qi_gathering_pill',     name: 'Qi Gathering Pill',     rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'meridian_opening_pill', name: 'Meridian Opening Pill', rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'flame_body_pill',       name: 'Flame Body Pill',       rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'iron_skin_pill',        name: 'Iron Skin Pill',        rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'earth_pulse_pill',      name: 'Earth Pulse Pill',      rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'spirit_sight_pill',     name: 'Spirit Sight Pill',     rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'qi_flow_pill',          name: 'Qi Flow Pill',          rarity: 'Bronze',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'profound_qi_pill',      name: 'Profound Qi Pill',      rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'dragon_blood_pill',     name: 'Dragon Blood Pill',     rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'soul_stabilizing_pill', name: 'Soul Stabilizing Pill', rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'vitality_pill',         name: 'Vitality Pill',         rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'heavenly_root_pill',    name: 'Heavenly Root Pill',    rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'deep_vein_pill',        name: 'Deep Vein Pill',        rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'qi_surge_pill',         name: 'Qi Surge Pill',         rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'combat_pill',           name: 'Combat Pill',           rarity: 'Silver',       description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'qi_ascension_pill',     name: 'Qi Ascension Pill',     rarity: 'Gold',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'true_element_pill',     name: 'True Element Pill',     rarity: 'Gold',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'heaven_marrow_pill',    name: 'Heaven Marrow Pill',    rarity: 'Gold',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'origin_gathering_pill', name: 'Origin Gathering Pill', rarity: 'Gold',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'qi_breakthrough_pill',  name: 'Qi Breakthrough Pill',  rarity: 'Gold',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'dao_heart_pill',        name: 'Dao Heart Pill',        rarity: 'Gold',         description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'immortal_qi_pill',      name: 'Immortal Qi Pill',      rarity: 'Transcendent', description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'heaven_defying_pill',   name: 'Heaven Defying Pill',   rarity: 'Transcendent', description: 'A cultivated pill that permanently improves base stats.' },
    { id: 'dao_foundation_pill',   name: 'Dao Foundation Pill',   rarity: 'Transcendent', description: 'A cultivated pill that permanently improves base stats.' },
